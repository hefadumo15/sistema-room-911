        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <router-link exact-active-class="active" to="/employees" class="nav-link">Employees</router-link>
                    </li>   
                     <li class="nav-item">
                        <router-link exact-active-class="active" to="/admins" class="nav-link">Admins</router-link>
                    </li>            
                </ul>
                <form class="d-flex">
